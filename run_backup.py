...
def hydra_algo_data_single(prob_info: Dict[str, Any], 
    ...
    # Retrieve derived data from the run via logger properties.
    ...
    return {
        ...
        "unique_true_fits": unique_true_fits,
        "unique_noisy_fits": unique_noisy_fits,
        ...
        "noisy_sol_variants": noisy_sol_variants,
        "seed": seed,
